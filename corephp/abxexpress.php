    ...
    function scrapping($waybill_number)
    {
        ...
        if(!empty($li)){
            ...
            foreach ($li as $key => $value) {
                $location = !empty($value->find('div[class="title"]',0)->innertext) ? ($value->find('div[class="title"]',0)->innertext) : '';
                $details = !empty($value->find('div[class="info"]',0)->innertext) ? ($value->find('div[class="info"]',0)->innertext) : '';
                ...
                $date = !empty($value->find('div[class="time"] span',0)->innertext) ? ($value->find('div[class="time"] span',0)->innertext) : '';
                $time = !empty($value->find('div[class="time"] span',1)->innertext) ? ($value->find('div[class="time"] span',1)->innertext) : '';
